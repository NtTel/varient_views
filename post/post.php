        ...
        <div class="row">
            ...
            <div id="content" class="<?php echo ($post->show_right_column == 1) ? 'col-sm-8' : 'col-sm-12'; ?> col-xs-12">
                ...
                <div class="post-content">
                    ...
                    <h1 class="title"><?php echo html_escape($post->title); ?>
					<?php if (check_user_permission('admin_panel')): ?>
							<span class="post_edit"><i class="icon-edit"></i><a target="_blank" href="<?php echo admin_url(); ?>update-post/<?php echo html_escape($post->id); ?>"><?php echo trans('edit'); ?></a></span>
						<?php endif; ?></h1>
